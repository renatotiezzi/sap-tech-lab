...
METHOD if_lobm_before_batch_nmbr_int~before_number_assignment.
  ...
  DATA: lv_zzgrpma TYPE zzgrpma.   " confirmar domínio/tipo com o dev do RAP App
...
METHOD if_lobm_after_batch_nmbr_int~after_number_assignment.  " nome do método a confirmar
  ...
  CALL FUNCTION '/ACHE/MMF_LOTE_DETERMINAR'
    EXPORTING
      i_matnr          = batch_allocation-material        " confirmar nome do componente
      i_werks          = batch_allocation-plant            " confirmar nome do componente
