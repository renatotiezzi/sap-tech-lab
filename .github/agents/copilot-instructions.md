...
- Prefer maintainable and upgrade-safe approaches.
- Analyze screenshots carefully when provided.
- Consider customizing, authorization and master data before suggesting code changes.
